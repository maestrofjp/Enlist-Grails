			...
			<div class="span9">
				...
				<dl>
					...
					<g:if test="${statusInstance?.status}">
						<dt><g:message code="status.status.label" default="Status" /></dt>
						
							<dd><g:fieldValue bean="${statusInstance}" field="status"/></dd>
				...
				<g:form>
					...
					<div class="form-actions">
						<g:link class="btn" action="edit" id="${statusInstance?.id}">
